  ...
  <div>
    <div class="header">
      ...
      <div class="badge">
        ...
        <button><label>Statistical Programming Languages</label></button>
    ...
    <div class="content">
      ...
      <div class="button">
        <button @click="openWindow('projectsWindow')">
          <img src='@/assets/icons/win95/projects.png'>
          <label>Projects</label>
        </button>
        <button @click="openWindow('skillsWindow')">
          <img src='@/assets/icons/win95/skills.png'>
          <label>Skills</label>
        </button>
        <button @click="openWindow('experiencesWindow')">
          <img src='@/assets/icons/win95/experiences.png'>
          <label>Experiences</label>
        </button>
        <button @click="openWindow('educationsWindow')">
          <img src='@/assets/icons/win95/educations.png'>
          <label>Educations</label>
        </button>
        <button @click="openWindow('certificationsWindow')">
          <img src='@/assets/icons/win95/certifications.png'>
          <label>Certifications</label>
        </button>
        <button @click="openWindow('publicationsWindow')">
